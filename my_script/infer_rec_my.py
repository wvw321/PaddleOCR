...
def main():
    ...
    with open(save_res_path, "w") as fout:
        for file in get_image_file_list(infer_imgs, infer_list=infer_list):
            ...
            data__[os.path.basename(file)] = post_result[0][0]
            if post_result[0][1] <=0.7:
                print(os.path.basename(file),post_result[0][1],post_result[0][0])
    ...
    with open("labels_val.txt", "w", encoding="utf-8") as file:
        for kay in data__.keys():
            file.write(kay + "\t" + data__[kay] + "\n")
